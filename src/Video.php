...
class Video
{
     ...
     * @return Video self
     */
    public static function fromJson(object $json): Video
    {
        $id = '';
        if (!empty($json->id)) {
            $id = $json->id;
        ...
        return new self($id, $share_url, $create_time, $cover_image_url, $video_description, $duration, $height, $width,
            $title, $embed_html, $embed_link, $like_count, $comment_count, $share_count, $view_count);
    }
