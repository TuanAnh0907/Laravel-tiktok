...
class User
{
     ...
     * @return User self
     */
    public static function fromJson(object $json, bool $get_username_remote = false): User
    {
        $open_id       = '';
        $union_id      = '';
        $avatar        = '';
        ...
        return new self($open_id, $union_id, $avatar, $avatar_larger, $display_name, $avatar_thumb, $bio, $url,
            $is_verified, $followers, $following, $likes, $num_videos, $handle);
    }
    ...
    /**
     * Get the Deep linked Profile Url
